# UAW Local 647 — Concept 4: Modern & Vibrant

A full Jekyll build of the "Modern & Vibrant" homepage concept, extended
...
- `assets/css/style.css` — this concept's visual language (Manrope/Inter,
  navy/gold/red palette, rounded bento grids and color-block cards).
